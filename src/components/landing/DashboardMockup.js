export default function DashboardMockup() {
  return (
    <div className="relative rounded-[2.25rem] border border-slate-200/90 bg-white/80 p-4 sm:p-5 shadow-2xl shadow-slate-200/50 backdrop-blur-md">
      {/* App Frame Header */}
      <div className="flex items-center justify-between pb-3.5 border-b border-slate-100 mb-3.5 px-2">
        ...
        <div className="text-[9px] sm:text-[10px] font-bold text-slate-500 uppercase tracking-widest bg-slate-50 border border-slate-100 rounded-full px-3.5 py-1 select-none">
          TripEZ • AI Travel Dashboard
        </div>
        <span className="w-8" aria-hidden="true" />
      </div>

      {/* Central Mockup Workspace */}
      <div className="relative bg-slate-950 rounded-[1.5rem] p-4 sm:p-5 text-white overflow-hidden shadow-inner min-h-[290px] flex flex-col justify-between">
        {/* Background Glows */}
        <div className="absolute -top-12 -left-12 w-36 h-36 bg-sky-500/10 rounded-full blur-2xl pointer-events-none" aria-hidden="true" />
        <div className="absolute -bottom-12 -right-12 w-36 h-36 bg-indigo-500/10 rounded-full blur-2xl pointer-events-none" aria-hidden="true" />

        {/* Mockup Trip Info Header */}
        <div className="relative flex items-center justify-between text-[11px] text-slate-400 font-bold border-b border-white/10 pb-2.5">
      ...
      <div className="absolute -left-4 sm:-left-10 bottom-4 sm:-bottom-16 bg-white/95 border border-slate-200/80 p-3.5 sm:p-4 rounded-2xl shadow-xl w-44 sm:w-48 backdrop-blur-md hidden sm:block hover:scale-105 hover:shadow-2xl transition-all duration-300">
      ...
      <div className="absolute -right-4 sm:-right-10 -top-6 sm:-top-8 bg-white/95 border border-slate-200/80 p-3.5 sm:p-4 rounded-2xl shadow-xl w-48 sm:w-52 backdrop-blur-md hidden sm:block hover:scale-105 hover:shadow-2xl transition-all duration-300">
        <div className="flex items-center gap-2.5">
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="flex -space-x-1.5">
            <div className="h-6 w-6 rounded-full bg-sky-500 border-2 border-white flex items-center justify-center text-[7px] font-bold text-white shadow-sm">
              AR
            </div>
            <div className="h-6 w-6 rounded-full bg-indigo-500 border-2 border-white flex items-center justify-center text-[7px] font-bold text-white shadow-sm">
              KS
            </div>
            <div className="h-6 w-6 rounded-full bg-emerald-500 border-2 border-white flex items-center justify-center text-[7px] font-bold text-white shadow-sm">
              JD
            </div>
          </div>
